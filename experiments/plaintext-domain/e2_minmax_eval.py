...
if __name__ == "__main__":
    ...
    for strategy in ["global","per-feature"]:
        for dim in dimensions:
            print()
            print(f"Results for dimension:{dim} with minmax: {strategy}")
            # Run evaluation
            evaluate_lfw(embeddings, labels, pca_dim=dim, minmax_strategy=strategy)
